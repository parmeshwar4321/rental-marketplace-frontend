        ...
        <div className="flex mt-4">
          ...
          <Link href="/">
            <a className="relative inline-flex items-center justify-center px-6 py-3 text-black font-small tracking-tighter text-white bg-gray-800 mr-6 rounded-md group">
              ...
              <span className="relative text-sm text-pink-600 font-bold transition-colors duration-200 ease-in-out delay-100 group-hover:text-white">HOME</span>
            </a>
          </Link>
          ...
          <Link href="/create-item">
            <a className="relative inline-flex items-center justify-center px-6 py-3 text-black font-small tracking-tighter text-white bg-gray-800 mr-6 rounded-md group">
              ...
              <span className="absolute inset-0 w-full h-full bg-white rounded-md "></span>
              <span className="absolute inset-0 w-full h-full transition-all duration-200 ease-in-out delay-100 bg-pink-600 rounded-md opacity-0 group-hover:opacity-100 "></span>
              <span className="relative text-sm text-pink-600 font-bold transition-colors duration-200 ease-in-out delay-100 group-hover:text-white">CREATE</span>
            </a>
          </Link>
          ...
          <Link href="/my-assets">
            <a className="relative inline-flex items-center justify-center px-6 py-3 text-black font-small tracking-tighter text-white bg-gray-800 mr-6 rounded-md group">
              ...
              <span className="absolute inset-0 w-full h-full bg-white rounded-md "></span>
              <span className="absolute inset-0 w-full h-full transition-all duration-200 ease-in-out delay-100 bg-pink-600 rounded-md opacity-0 group-hover:opacity-100 "></span>
              <span className="relative text-sm text-pink-600 font-bold transition-colors duration-200 ease-in-out delay-100 group-hover:text-white">OWN</span>
            </a>
          </Link>
          ...
          <Link href="/my-rents">
            <a className="relative inline-flex items-center justify-center px-6 py-3 text-black font-small tracking-tighter text-white bg-gray-800 mr-6 rounded-md group">
              ...
              <span className="absolute inset-0 w-full h-full bg-white rounded-md "></span>
              <span className="absolute inset-0 w-full h-full transition-all duration-200 ease-in-out delay-100 bg-pink-600 rounded-md opacity-0 group-hover:opacity-100 "></span>
              <span className="relative text-sm text-pink-600 font-bold transition-colors duration-200 ease-in-out delay-100 group-hover:text-white">RENTING</span>
            </a>
          </Link>
          ...
          <Link href="/claimable-assets">
            <a className="relative inline-flex items-center justify-center px-6 py-3 text-black font-small tracking-tighter text-white bg-gray-800 mr-6 rounded-md group">
              ...
              <span className="absolute inset-0 w-full h-full bg-white rounded-md "></span>
              <span className="absolute inset-0 w-full h-full transition-all duration-200 ease-in-out delay-100 bg-pink-600 rounded-md opacity-0 group-hover:opacity-100 "></span>
              <span className="relative text-sm text-pink-600 font-bold transition-colors duration-200 ease-in-out delay-100 group-hover:text-white">RENTABLE</span>
            </a>
          </Link>
