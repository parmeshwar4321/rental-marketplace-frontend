  ...
  return (
    <div className="flex justify-center bg-black">
      <div className="w-1/2 flex flex-col pb-12">
        <label htmlFor="AssetName" className=" my-12 block mb-2 text-lg font-medium text-white">🤍NFT RENTAL NAME</label>
        <input 
          placeholder="Name 🖼"
        ...
        <textarea
          placeholder="A short description of your 🤍NFT rental."
        ...
        <label htmlFor="AssetPrice" className=" my-6 block mb-2 text-lg font-medium text-white">🤍NFT PRICE</label>
        <input
        ...
        <label htmlFor="formFile" className=" my-6 form-label inline-block mb-2 text-white-700 text-lg font-bold">UPLOAD 🤍NFT IMAGE</label>
